...
class TrainerProfessorGui extends StatefulWidget {
  // ignore: use_super_parameters
  const TrainerProfessorGui({Key? key}) : super(key: key);

  @override
  State<TrainerProfessorGui> createState() => _TrainerProfessorGuiState();
}

class _TrainerProfessorGuiState extends State<TrainerProfessorGui> {
                        ...
                        children: [
                          ...
                          Positioned(
                              ...
                              child: SizedBox(
                                ...
                                height: height * 0.6,
                                child: Image.asset(
                                  'images/Professor-Gui-Profile.png',
                                  fit: BoxFit.contain,
                                ),
                              )
                  ...
                  children: [
                    ...
                    if (showTextField1)
                      Padding(
                        ...
                        child: const Text(
                          '''Professor Gui is an accomplished Brazilian Jiu-Jitsu practitioner with a lifelong dedication to the sport. Inspired by Royce Gracie, he overcame financial obstacles to train and began teaching with his brother.\n\nThey founded Academia Guetho Jiu-Jitsu, a prominent team in southern Brazil. Professor Gui earned his black belt in 2008 and joined the Atos Jiu-Jitsu team in 2009.\n\nIn 2016, he moved to the United States to provide a better life for his daughters and spread authentic Jiu-Jitsu.\n\nNow in Texas, he aims to cultivate champions and positively impact lives through the transformative power of Jiu-Jitsu.Professor Gui is an accomplished Brazilian Jiu-Jitsu practitioner with a lifelong dedication to the sport. Inspired by Royce Gracie, he overcame financial obstacles to train and began teaching with his brother.\n\nThey founded Academia Guetho Jiu-Jitsu, a prominent team in southern Brazil. Professor Gui earned his black belt in 2008 and joined the Atos Jiu-Jitsu team in 2009.\n\nIn 2016, he moved to the United States to provide a better life for his daughters and spread authentic Jiu-Jitsu.\n\nNow in Texas, he aims to cultivate champions and positively impact lives through the transformative power of Jiu-Jitsu.''',
                        ),
                      ),
                    if (showTextField2)
                      Padding(
