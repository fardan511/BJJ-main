...
class TrainerScott2 extends StatefulWidget {
  const TrainerScott2({Key? key}) : super(key: key);

  @override
  State<TrainerScott2> createState() => _TrainerScott2State();
}

class _TrainerScott2State extends State<TrainerScott2> {
                  ...
                  children: [
                    ...
                    if (showTextField1)
                      Padding(
                        ...
                        child: const Text(
                          '''Test account created for beta testing as a coach""Test account created for beta testing as a coach''',
                        ),
                      ),
                    if (showTextField2)
                      Padding(
