...
class TrainerDisplayingGig extends StatefulWidget {
  final bool fromTrainer;
  final QueryDocumentSnapshot data;
  const TrainerDisplayingGig({
    super.key,
  ...
  @override
  State<TrainerDisplayingGig> createState() => _TrainerDisplayingGigState();
}

class _TrainerDisplayingGigState extends State<TrainerDisplayingGig> {
