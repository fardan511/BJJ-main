...
class StudentCancelledServices extends StatefulWidget {
  const StudentCancelledServices({Key? key}) : super(key: key);

  @override
  State<StudentCancelledServices> createState() => _StudentCancelledServicesState();
}

class _StudentCancelledServicesState extends State<StudentCancelledServices> {
  @override
