...
class StudentDispute extends StatefulWidget {
  const StudentDispute({super.key});

  @override
  State<StudentDispute> createState() => _StudentDisputeState();
}

class _StudentDisputeState extends State<StudentDispute> {
  @override
