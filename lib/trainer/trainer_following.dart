...
class TrainerFollowing extends StatefulWidget {
  const TrainerFollowing({Key? key}) : super(key: key);

  @override
  State<TrainerFollowing> createState() => _TrainerFollowingState();
}

class _TrainerFollowingState extends State<TrainerFollowing> {
  @override
