...
import '../chat/chatterScreen.dart';

class TrainerMessage extends StatefulWidget {
  const TrainerMessage({Key? key}) : super(key: key);

  @override
  State<TrainerMessage> createState() => _TrainerMessageState();
}

class _TrainerMessageState extends State<TrainerMessage> {
  @override
            ...
            children: [
              ...
              StreamBuilder(
                stream: FirebaseFirestore.instance
                    .collection('messages')
                    .where('user_ids.${auth.currentUser!.uid}', isEqualTo: true)
                    .snapshots(),
                builder: (context, snapshot) {
                  if (!snapshot.hasData) {
                    return const SizedBox();
