...
class TrainerOngoingProject extends StatefulWidget {
  const TrainerOngoingProject({Key? key}) : super(key: key);

  @override
  State<TrainerOngoingProject> createState() => _TrainerOngoingProjectState();
}

class _TrainerOngoingProjectState extends State<TrainerOngoingProject> {
  @override
