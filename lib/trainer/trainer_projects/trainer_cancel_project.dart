...
class TrainerCencelProject extends StatefulWidget {
  const TrainerCencelProject({Key? key}) : super(key: key);

  @override
  State<TrainerCencelProject> createState() => _TrainerCencelProjectState();
}

class _TrainerCencelProjectState extends State<TrainerCencelProject> {
  @override
