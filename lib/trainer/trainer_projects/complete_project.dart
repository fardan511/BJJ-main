...
class TrainerCompleteProject extends StatefulWidget {
  const TrainerCompleteProject({Key? key}) : super(key: key);

  @override
  State<TrainerCompleteProject> createState() => _TrainerCompleteProjectState();
}

class _TrainerCompleteProjectState extends State<TrainerCompleteProject> {
  @override
