...
class TrainerProjectsWishlist extends StatefulWidget {
  const TrainerProjectsWishlist({Key? key}) : super(key: key);

  @override
  State<TrainerProjectsWishlist> createState() =>
      _TrainerProjectsWishlistState();
}

class _TrainerProjectsWishlistState extends State<TrainerProjectsWishlist> {
  @override
