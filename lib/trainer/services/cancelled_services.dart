...
class CancelledServices extends StatefulWidget {
  const CancelledServices({Key? key}) : super(key: key);

  @override
  State<CancelledServices> createState() => _CancelledServicesState();
}

class _CancelledServicesState extends State<CancelledServices> {
  @override
