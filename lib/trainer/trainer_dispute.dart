...
class TrainerDispute extends StatefulWidget {
  const TrainerDispute({Key? key}) : super(key: key);

  @override
  State<TrainerDispute> createState() => _TrainerDisputeState();
}

class _TrainerDisputeState extends State<TrainerDispute> {
  @override
