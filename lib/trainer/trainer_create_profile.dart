...
class TrainerEditProfile extends StatefulWidget {
  const TrainerEditProfile({Key? key}) : super(key: key);

  @override
  State<TrainerEditProfile> createState() => _TrainerEditProfileState();
}
...
class _TrainerEditProfileState extends State<TrainerEditProfile> {
  ...
  void saveProfile() async {
    if (_usernameController.text.trim().isEmpty ||
        ...
        _profileTitleController.text.trim().isEmpty ||
        _hourlyRateController.text.trim().isEmpty ||
        _bioController.text.trim().isEmpty ||
        _livingController.text.trim().isEmpty ||
        ...
        _otherLinkController.text.trim().isEmpty ||
        chosenGender == null ||
        chosenLevel == null ||
        chosenLocation == null ||
        chosenNoOfYears == null) {
