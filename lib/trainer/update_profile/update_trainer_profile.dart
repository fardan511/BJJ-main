...
class UpdateTrainerProfile extends StatefulWidget {
  const UpdateTrainerProfile({Key? key}) : super(key: key);

  @override
  State<UpdateTrainerProfile> createState() => _UpdateTrainerProfileState();
}

class _UpdateTrainerProfileState extends State<UpdateTrainerProfile> {
  String userPhotoUrl = '';
  File? _uploadImage;
  final updateTrainerImage = GlobalKey<FormState>();
  bool isTeacherUpdateProfile = false;
  ...
  void submitFormOnSignUp() async {
    final isValid = updateTrainerImage.currentState!.validate();
    if (isValid) {
