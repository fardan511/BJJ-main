...
class TrainerVerification extends StatefulWidget {
  const TrainerVerification({Key? key}) : super(key: key);

  @override
  State<TrainerVerification> createState() => _TrainerVerificationState();
}

class _TrainerVerificationState extends State<TrainerVerification> {
  @override
